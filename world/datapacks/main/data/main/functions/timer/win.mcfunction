...
#Title
title @s[scores={win_timer=1}] times 1 100 20
title @s[scores={win_timer=2}] title {"text":"T","color":"yellow"}
title @s[scores={win_timer=4}] title {"text":"Th","color":"yellow"}
title @s[scores={win_timer=6}] title {"text":"The","color":"yellow"}
title @s[scores={win_timer=8}] title {"text":"The ","color":"yellow"}
title @s[scores={win_timer=10}] title {"text":"The E","color":"yellow"}
title @s[scores={win_timer=12}] title {"text":"The En","color":"yellow"}
title @s[scores={win_timer=14}] title {"text":"The End","color":"yellow"}
