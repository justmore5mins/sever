...
scoreboard objectives add aj.wheelguy.animating dummy
scoreboard objectives add aj.wheelguy.idle.loopMode dummy
function wheelguy:reset_animation_flags
scoreboard players set #uninstall aj.i 0
scoreboard players set .aj.wheelguy.framerate aj.i 1
